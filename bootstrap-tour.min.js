  ...
  return o = window.document, e = function() {
    function e(e) {
      ...
      this._options = t.extend({
        ...
        delay: !1,
        basePath: "",
        template: '<div class="popover" role="tooltip"> <div class="arrow"></div> <h3 class="popover-title"></h3> <div class="popover-content"></div> <div class="popover-navigation"> <div class="btn-group"> <button class="btn btn-sm btn-default" data-role="prev">&laquo; Előző</button> <button class="btn btn-sm btn-default" data-role="next">Következő &raquo;</button> <button class="btn btn-sm btn-default" data-role="pause-resume" data-pause-text="pause" data-resume-text="resume">Szünet</button> </div> <button class="btn btn-sm btn-default" data-role="end">Befejezés</button> </div> </div>',
    ...
    return e.prototype.addSteps = function(t) {
      ...
      }(this), n)) : this._callOnPromiseDone(i, r), i) : void 0
      ...
      }.call(this), !a.redirect || !this._isRedirect(a.host, e, o.location) || (this._redirect(a, t, e), this._isJustPathHashDifferent(a.host, e, o.location))) ? (i = function(e) {
        return function() {
          var o;
          if (e._isOrphan(a)) {
      ...
      var i;
      return t.isFunction(e.redirect) ? e.redirect.call(this, r) : (i = "[object String]" === {}.toString.call(e.host) ? "" + e.host + r : r, this._debug("Redirect to " + i), this._getState("redirect_to") !== "" + n ? (this._setState("redirect_to", "" + n), o.location.href = i) : (this._debug("Error redirection loop to " + r), this._removeState("redirect_to"), null != e.onRedirectError ? e.onRedirectError(this) : void 0))
      ...
      return t(".tour-" + this._options.name).remove(), s = t.extend({}, this._options), i = this._isOrphan(e), e.template = this._template(e, o), i && (e.element = "body", e.placement = "top"), n = t(e.element), n.addClass("tour-" + this._options.name + "-element tour-" + this._options.name + "-" + o + "-element"), e.options && t.extend(s, e.options), e.reflex && !i && t(e.reflexElement).addClass("tour-step-element-reflex").off("" + this._reflexEvent(e.reflex) + ".tour-" + this._options.name).on("" + this._reflexEvent(e.reflex) + ".tour-" + this._options.name, function(t) {
        ...
        template: e.template,
        selector: e.element
      }).popover("show"), r = n.data("bs.popover") ? n.data("bs.popover").tip() : n.data("popover").tip(), r.attr("id", e.id), this._focus(r, n, e.next < 0), this._reposition(r, e), i ? this._center(r) : void 0
      ...
      var r, i, s, a, u, p, h;
      if (a = e[0].offsetWidth, i = e[0].offsetHeight, h = e.offset(), u = h.left, p = h.top, r = t(o).outerHeight() - h.top - e.outerHeight(), 0 > r && (h.top = h.top + r), s = t("html").outerWidth() - h.left - e.outerWidth(), 0 > s && (h.left = h.left + s), h.top < 0 && (h.top = 0), h.left < 0 && (h.left = 0), e.offset(h), "bottom" === n.placement || "top" === n.placement) {
        if (u !== h.left) return this._replaceArrow(e, 2 * (h.left - u), a, "left")
      } else if (p !== h.top) return this._replaceArrow(e, 2 * (h.top - p), i, "top")
      ...
      var n, r, i;
      return r = t(e.element), n = t(e.backdropElement), !r || 0 === r.length || this.backdrop.overlayElementShown && !o ? void 0 : (this.backdrop.overlayElementShown || (this.backdrop.$element = n.addClass("tour-step-backdrop"), this.backdrop.$background = t("<div>", {
